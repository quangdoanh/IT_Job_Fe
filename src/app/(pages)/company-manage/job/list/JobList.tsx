...
export const JobList = () => {
    ...
    const handleDeleteSuccess = (id: string) => {
        ...
        setPage(null as any);  // set tạm giá trị khác
        setTimeout(() => setPage(1), 0); // rồi set lại 1
    }
    ...
    return (
        <>
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[20px]">
                {jobList.map(item => {
                    const position = positionList.find(itemPos => itemPos.value == item.position)?.label; // nếu có thì lấy label
